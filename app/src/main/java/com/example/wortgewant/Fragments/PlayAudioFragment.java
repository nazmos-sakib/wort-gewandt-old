package com.example.wortgewant.Fragments;

import static com.example.wortgewant.R.drawable.baseline_pause_24;
import static com.example.wortgewant.R.drawable.baseline_play_arrow_24;
...
public class PlayAudioFragment extends Fragment {
    ...
    public void onStart() {
        ...
        play.setOnClickListener(View->{
            play.setImageDrawable(requireContext().getDrawable(baseline_pause_24));
    ...
    private void updateUI()  {
        ...
        play.setImageDrawable(requireContext().getDrawable(baseline_play_arrow_24));
    }
